...
namespace Content.Client._COYOTE.Helpers;
/// <summary>
/// This class is copied directly from RobustToolbox so that it can be accessed publicly
/// </summary>
public static class StringEnumerateHelpers
{
